...
def paras_args():
    ...
    parser.add_argument('--candidate_num',default=4, type=int, help='Size of candidate sets')
    parser.add_argument('--iteration_num',default=100, type=int, help='Number of iterations for stage 1')
...
def main(args):
    ...
    ranker = DEmORanker(model, tokenizer, prompter, trainset.data_info['label_space'], candidate_num=args.candidate_num, iteration_num=args.iteration_num)

    demos_l = [ranker.rank(original_demos, d, len(original_demos)) for d in tqdm(testset)]
